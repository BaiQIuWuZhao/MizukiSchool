...
export const siteConfig: SiteConfig = {
	title: "禺山校园墙Testing",
	subtitle: "莘莘学子，志气高昂。",
	siteURL: "https://blog.baiqiuwuzhao.com/", // 请替换为你的站点URL，以斜杠结尾
...
export const announcementConfig: AnnouncementConfig = {
	title: "欢迎来到禺山校园墙", // 公告标题，填空使用i18n字符串Key.announcement
	content: "*广州市禺山高级中学", // 公告内容
